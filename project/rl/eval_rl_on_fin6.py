...
CTID_PATH = PROJECT_ROOT / "data_v2" / "external_ctid" / "parsed" / "ctid_eval_parent_fin6_in184.csv"
OUT_PATH = PROJECT_ROOT / "rl" / "rl_fin6_predictions_top5.csv"
...
def main():
    ...
    print("=== APT29 / CTID EXTERNAL EVAL ===")
